...
Param = sdo.getParameterFromModel('TwoEyesModel',...
    {'H','K','Ka','Kh','Kvsm','Ta','Th','Tvsm'});
Param(1).Minimum = 0;
Param(1).Maximum = 10;
Param(2).Minimum = 0;
Param(2).Scale = 0.0625;
Param(3).Minimum = 0.2;
Param(3).Scale = 4;
Param(4).Minimum = 0;
Param(4).Scale = 0.5;
...
% Param(1).Minimum = 0; Param(1).Maximum = 100;
% Param(2).Minimum = 0; Param(2).Maximum = 100;
% Param(3).Minimum = 0; Param(3).Maximum = 100;
% Param(4).Minimum = 0; Param(4).Maximum = 100;
% Param(5).Minimum = 100; Param(5).Maximum = 1000;
% Param(6).Minimum = 10; Param(6).Maximum = 100;
% Param(8).Minimum = 0; Param(8).Maximum = 10;
% 
% Param(1).Value = x(1);
% Param(2).Value = x(2);
% Param(3).Value = x(3);
